...
C {NOR.sym} 32.5 0 0 0 {name=x1}
C {devices/vsource.sym} -505 -342.5 0 0 {name=V3 value=1.8}
C {devices/vsource.sym} -695 -342.5 0 0 {name=V4 value="pulse 0 1.8 0 350n 0 0 1u"}
...
C {devices/vsource.sym} -915 -342.5 0 0 {name=V5 value="pulse 0 1.8 5n .1n .1n 40n 80n"}
...
.endc
"}
C {NOR.sym} 32.5 230 0 0 {name=x2}
C {NOR.sym} 32.5 435 0 0 {name=x3}
C {NOR.sym} 30 645 0 0 {name=x4}
...
C {devices/vsource.sym} -252.5 -340 0 0 {name=V6 value=1.125}
...
C {NOR.sym} 27.5 902.5 0 0 {name=x5}
C {NOR.sym} 27.5 1132.5 0 0 {name=x6}
C {NOR.sym} 27.5 1337.5 0 0 {name=x7}
C {NOR.sym} 25 1547.5 0 0 {name=x8}
